package com.example.nativebaseproject.common.dialog
...
import com.example.nativebaseproject.databinding.ViewDialogBinding
...
//    </style>
    ...
    fun show(): AlertDialog {
        ...
        val inset = InsetDrawable(back, 10f.toPixel(context).toInt())
